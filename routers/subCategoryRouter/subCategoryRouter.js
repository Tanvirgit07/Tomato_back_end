...
const { addSubCategory, editSubCategory, getAllSubCategory } = require("../../controllers/subCategoryController/SubCategoryController");
...
// subCategoryRouter.get("/getsingecategory", );
